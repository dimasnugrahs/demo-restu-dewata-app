...
async function generateExcelBuffer(transactions) {
  ...
  worksheet.columns = [
    { header: "No. Rekening", key: "nasabah_id", width: 30 }, // 1. dari tabel customer/Nasabah
    {
      header: "Jumlah",
      key: "amount",
      width: 20,
    ...
    { header: "My Kode Trans", key: "transaction_type", width: 20 },
    { header: "User ID", key: "office_code", width: 20 },
...
export async function GET() {
  try {
    ...
    const transactions = await db.transaction.findMany({
      where: {
        OR: [{ office_code: "111" }, { office_code: "136" }], // HANYA ambil transaksi yang office_code-nya "111"
      },
