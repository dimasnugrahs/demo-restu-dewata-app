...
export default function DeleteAllTransactionsCabangButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className=" py-2 px-4 lg:ml-2 ml-0 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 transition duration-150 ease-in-out"
    >
